...
#' separated value (CSV) file or GeoPackage (GPKG) file in a directory
#' specified by the user, defaulting to the current working directory.
#'
...
#' please refer to the \code{vignette("GSODR output fields", package = "GSODR")}.
#' 
