#'Stations
#'
#' @format A data frame with 24881 observations of 13 variables:
#' \describe{
...
#'   \item{CTRY}{United States Federal Information Processing Standards (FIPS)
#'   country ID (2 letter identifier)}
