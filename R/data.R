...
#' \describe{
#'   \item{STNID}{Unique station ID, a concatenation of USAF and WBAN number, used for merging with station data weather files}
#'   \item{ELEV_M_SRTM_90m}{Elevation in metres extracted from SRTM data (Jarvis \emph{et al}. 2008)}
#' }
#'
#' Station elevation information for the US National Climatic Data Centre (NCDC) Global Surface Summary of the Day (GSOD) weather data. The original file has
#' missing and incorrect geographic data including location (LAT/LON) and elevation. This data frame provides an alternative set of elevation values
...
#' \item{Stations with longitude values that are beyond -180/180 degrees were removed.}
#' \item{Stations with latitude values that are beyond -90/90 degrees were removed.}
#' \item{A new field for elevation is included, ELEV_M_SRTM_90m. This was created using mean values of a 200m buffer around the reported LAT/LON
...
#' @references {Jarvis, A, HI Reuter, A Nelson, E Guevara, 2008, Hole-filled SRTM for the globe Version 4, available from the CGIAR-CSI SRTM 90m Database
...
#' @note Users of these data should take into account the following (from the NCDC website): \dQuote{The following data and products may have conditions
#' placed on their international commercial use. They can be used within the U.S. or for non-commercial international activities without restriction. The
#' non-U.S. data cannot be redistributed for commercial purposes. Re-distribution of these data by others must provide this same notification.}
#'
#' The \code{country_list} data are automatically loaded with the \code{GSODR} package.
#'
