---
title: "GSODR: Global Surface Summary of the Day (GSOD) Weather Data from R"
...
[![CRAN_Status_Badge](http://www.r-pkg.org/badges/version/GSODR)](https://cran.r-project.org/package=GSODR)
...
- `get_inventory()`, downloads the latest station inventory information from the
    NCEI FTP server and returns the header information about the latest version
    as a message in the console and a `tibble()` of station inventory for
    each month that it provides data.
...
from the NCEI server. Following is an example of its capabilities, for more
detailed examples of its capabilities, please see the [_GSODR_ introduction vignette](https://ropensci.github.io/GSODR/articles/GSODR.html).
