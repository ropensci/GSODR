...
This package is only available from GitHub; due to its large size (5.5Mb installed) it is not allowed on CRAN. It provides optional data for use with the `GSODR` package. See https://github.com/ropensci/GSODRdata for more.
