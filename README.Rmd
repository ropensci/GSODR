...
The function, `get_GSOD()`, returns a `data.frame()` object in R and can also save a Comma Separated Value (CSV) file or GeoPackage (GPKG) file for use in a GIS. Station data are merged with weather data for the final file which includes the following fields:
