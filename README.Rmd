...
GeoPackage file, implemented by most major GIS softwares, summarizing each year 
y station, which includes vapour pressure and relative humidity variables
...
GeoPackage in the respective year directory containing the following
variables:  
