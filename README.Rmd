...
analysis. The _GSODR_ package provides four main functions for facilitating this:
...
The _GSODR_ package returns data with the following fields/units.
...
Compare the GSOD weather data from the Philippines with climatic data provided by the _GSODRdata_ package in the `CHELSA` data set.
...
![Comparison of GSOD daily values and average monthly values with CHELSA climate monthly values](vignettes/figure/example_1.2-1.png)
