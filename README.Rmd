...
Celsius. Output is saved as a Comma Separated Value (CSV) file or a spatial file
in a GeoPackage file format summarizing each year by station, which includes
...
branch on GitHub functional and working properly, you have been warned.
...
The function, `get_GSOD()` generates a Comma Separated Value (CSV) file or ESRI
format shapefile in the respective year directory containing the following
variables:  
...
derived from the hourly data (I_e., highest hourly or synoptic-reported
temperature);  
...
with the midnight observation--I_e., may include latter part of previous
...
**I_RN\_DZL** - Indicator for rain or drizzle, (1 = yes, 0 = no/not
reported) for the occurrence during the day;  
**I_SNW\_ICE** - Indicator for snow or ice pellets, (1 = yes, 0 = no/not
reported) for the occurrence during the day;  
...
**I_TDO\_FNL** - Indicator for tornado or funnel cloud, (1 = yes, 0 =
