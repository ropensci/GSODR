...
**I.RAIN_DZL** - Rain or drizzle, (1 = yes, 0 = no/not reported) for the occurrence during
the day;  
**I.SNW_ICE** - Snow or ice, (1 = yes, 0 = no/not reported) for the occurrence during
the day;  
...
day;  
**I.TDO_FNL** - Tornado or funnel cloud, (1 = yes, 0 = no/not reported) for the occurrence during
the day;  
