...
```
    ...
    ## Classes 'tbl_df', 'tbl' and 'data.frame':    28099 obs. of  13 variables:
    ...
    ##  $ END            : int  20120323 20181113 20181113 20081231 19910806 20050228 20181113 20181113 20140523 20041030 ...
...
```
    ...
    ## # ... with 28,089 more rows, and 2 more variables: STNID <chr>,
    ## #   ELEV_M_SRTM_90m <dbl>
...
## R System Information
    ...
    ##    class                7.3-14     2015-08-30 [3] CRAN (R 3.5.1)
    ...
    ##    hrbrthemes         * 0.5.0.1    2018-08-19 [1] CRAN (R 3.5.1)
