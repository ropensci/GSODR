...
```
    ...
    ## Classes 'tbl_df', 'tbl' and 'data.frame':    28100 obs. of  13 variables:
    ...
    ##  $ END            : int  20120323 20181216 20181216 20081231 19910806 20050228 20181216 20181216 20140523 20041030 ...
...
```
    ...
    ## # ... with 28,090 more rows, and 2 more variables: STNID <chr>,
    ## #   ELEV_M_SRTM_90m <dbl>
