...
```{r download NE data, echo=TRUE, cache=TRUE}
...
```{r Hist difference SRTM 90m vs Buffered SRTM 90m, echo=TRUE, fig.cap="Histogram of CGIAR-CSI SRTM Buffered Elevation versus CGIAR-CSI SRTM 90m", warning=FALSE, error=FALSE, message=FALSE}
