...
```{r, echo=TRUE, fig.cap="CGIAR-CSI SRTM Buffered Elevation versus GSOD Reported Elevation"}

plot(stations$ELEV.M.SRTM_buffered ~ stations$ELEV.M)

```

```{r, echo=TRUE, fig.cap="CGIAR-CSI SRTM Buffered Elevation versus SRTM 90m"}
