...
corrected_elev <- as.data.frame(data.table::rbindlist(foreach(i = dem_tiles) %dopar% {
  ...
  if (!is.null(cropped_stations)) {
    ...
    corrected_elev <- as.data.frame(sub_stations)
...
corrected_elev[, 13] <- ifelse(is.na(corrected_elev[, 13]), corrected_elev[, 9], corrected_elev[, 13])
