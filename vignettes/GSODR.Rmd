...
##             <char>                       <char>   <num>   <num> <char> <char>    <int>    <int>
...
##   ---                                                                                          
## 1044: 959890-99999      BICHENO (COUNCIL DEPOT) -41.867 148.300     AS        19650101 20210115
## 1045: 959950-99999 LORD HOWE ISLAND WINDY POINT -31.533 159.067     AS        20120920 20210116
## 1046: 959970-99999    HEARD ISLAND (ATLAS COVE) -53.017  73.400     AS        19980301 20121220
## 1047: 996600-99999          ENVIRONM BUOY 55011 -40.800 144.300     AS        19930221 19970403
## 1048: 999999-82101               NORTHWEST CAPE -22.333 114.050     AS        19680305 19680430
...
##          <char>            <char>   <num>   <num> <char> <char>    <int>    <int>       <char>
## 1: 945510-99999         TOOWOOMBA -27.583 151.933     AS        19561231 20120503    AUSTRALIA
## 2: 955510-99999 TOOWOOMBA AIRPORT -27.550 151.917     AS        19980301 20210116    AUSTRALIA
##     ISO2C  ISO3C
##    <char> <char>
## 1:     AU    AUS
## 2:     AU    AUS
...
##    STATION-YEAR-MONTH for beginning of record through may 2022   
## Key: <STNID>
##               STNID                NAME    LAT    LON   CTRY  STATE    BEGIN      END
##              <char>              <char>  <num>  <num> <char> <char>    <int>    <int>
##     1: 008415-99999                <NA>     NA     NA   <NA>   <NA>       NA       NA
##     2: 010010-99999 JAN MAYEN(NOR-NAVY) 70.933 -8.667     NO        19310101 20210116
##     3: 010010-99999 JAN MAYEN(NOR-NAVY) 70.933 -8.667     NO        19310101 20210116
##     4: 010010-99999 JAN MAYEN(NOR-NAVY) 70.933 -8.667     NO        19310101 20210116
##     5: 010014-99999          SORSTOKKEN 59.792  5.341     NO        19861120 20210116
##    ---                                                                               
## 40161:   A51255-445                <NA>     NA     NA   <NA>   <NA>       NA       NA
## 40162:   A51255-445                <NA>     NA     NA   <NA>   <NA>       NA       NA
## 40163:   A51256-451                <NA>     NA     NA   <NA>   <NA>       NA       NA
## 40164:   A51256-451                <NA>     NA     NA   <NA>   <NA>       NA       NA
## 40165:   A51256-451                <NA>     NA     NA   <NA>   <NA>       NA       NA
##        COUNTRY_NAME  ISO2C  ISO3C  YEAR   JAN   FEB   MAR   APR   MAY   JUN   JUL   AUG   SEP
##              <char> <char> <char> <int> <int> <int> <int> <int> <int> <int> <int> <int> <int>
##     1:         <NA>   <NA>   <NA>  2020     0     0    14     0     0     0     0     0     0
##     2:       NORWAY     NO    NOR  2020   736   695   744   717   744   718   743   742   718
##     3:       NORWAY     NO    NOR  2021   686   562   729   710   733   654   726   717   712
##     4:       NORWAY     NO    NOR  2022   549   513   292    31     0     0     0     0     0
##     5:       NORWAY     NO    NOR  2020   546   513   401   251   228   288   320   452   484
##    ---                                                                                       
## 40161:         <NA>   <NA>   <NA>  2021  2106  2009  2163  1970  2209  2105  2194  2087  2098
## 40162:         <NA>   <NA>   <NA>  2022  2189  2004  2199  2149   227     0     0     0     0
## 40163:         <NA>   <NA>   <NA>  2020  2165  1455  2144  2125  2199  2123  2112  2192  2083
## 40164:         <NA>   <NA>   <NA>  2021  2085  1992  2217  1975  2146  2092  2227  2170  2080
## 40165:         <NA>   <NA>   <NA>  2022  2203  1937  2204  2144   223     0     0     0     0
##          OCT   NOV   DEC
##        <int> <int> <int>
##     1:     0     0     0
##     2:   694   708   740
...
##     5:   448   494   442
##    ---                  
## 40161:  2150  2122  2183
## 40162:     0     0     0
## 40163:  2079  2074  2187
## 40164:  2163  2120  2168
## 40165:     0     0     0
```
...
##           STNID              NAME    LAT     LON   CTRY  STATE    BEGIN      END COUNTRY_NAME
##          <char>            <char>  <num>   <num> <char> <char>    <int>    <int>       <char>
## 1: 955510-99999 TOOWOOMBA AIRPORT -27.55 151.917     AS        19980301 20210116    AUSTRALIA
## 2: 955510-99999 TOOWOOMBA AIRPORT -27.55 151.917     AS        19980301 20210116    AUSTRALIA
## 3: 955510-99999 TOOWOOMBA AIRPORT -27.55 151.917     AS        19980301 20210116    AUSTRALIA
...
## 3:     AU    AUS  2022   743   672   739   716    70     0     0     0     0     0     0     0
```
...
[NCEI website](https://www.ncei.noaa.gov/access/metadata/landing-page/bin/iso?id=gov.noaa.ncdc:C00516)): _
