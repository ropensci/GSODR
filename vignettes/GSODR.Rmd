...
<img src="figures/Ex5-1.png" title="plot of chunk Ex5" alt="plot of chunk Ex5" style="display: block; margin: auto;" />
...
```
## Error: There was a problem retrieving the inventory file. Perhaps 
...
```
## Error in eval(expr, envir, enclos): object 'inventory' not found
```
...
```
## Error in subset(inventory, STNID %in% "955510-99999"): object 'inventory' not found
```
