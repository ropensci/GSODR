...
##             <char>                       <char>   <num>   <num>   <num> <char> <char>    <int>    <int>
...
##   ---                                                                                                  
## 1415: 959890-99999      BICHENO (COUNCIL DEPOT) -41.867 148.300    11.0     AS        19650101 20240716
## 1416: 959950-99999 LORD HOWE ISLAND WINDY POINT -31.533 159.067     4.0     AS        20120920 20240717
## 1417: 959970-99999    HEARD ISLAND (ATLAS COVE) -53.017  73.400     4.0     AS        19980301 20121220
## 1418: 996600-99999          ENVIRONM BUOY 55011 -40.800 144.300     0.0     AS        19930221 19970403
## 1419: 999999-82101               NORTHWEST CAPE -22.333 114.050    38.1     AS        19680305 19680430
...
## 1: 945510-99999         TOOWOOMBA -27.583 151.933     676     AS        19561231 19971231    AUSTRALIA     AU
## 2: 955510-99999 TOOWOOMBA AIRPORT -27.550 151.917     642     AS        19980301 20240717    AUSTRALIA     AU
##     ISO3C
##    <char>
## 1:    AUS
## 2:    AUS
...
##  $ END             : int  20240717 20240717 20240717 20240717 20240717 20240717 20240717 20240717 20240717 20240717 ...
...
##    STATION-YEAR-MONTH for beginning of record through July 2024   
## Key: <STNID>
##                STNID                NAME    LAT    LON ELEV(M)   CTRY  STATE    BEGIN      END COUNTRY_NAME
##               <char>              <char>  <num>  <num>   <num> <char> <char>    <int>    <int>       <char>
##      1: 008415-99999                <NA>     NA     NA      NA   <NA>   <NA>       NA       NA         <NA>
##      2: 010010-99999 JAN MAYEN(NOR-NAVY) 70.933 -8.667       9     NO        19310101 20240717       NORWAY
##      3: 010010-99999 JAN MAYEN(NOR-NAVY) 70.933 -8.667       9     NO        19310101 20240717       NORWAY
##      4: 010010-99999 JAN MAYEN(NOR-NAVY) 70.933 -8.667       9     NO        19310101 20240717       NORWAY
##      5: 010010-99999 JAN MAYEN(NOR-NAVY) 70.933 -8.667       9     NO        19310101 20240717       NORWAY
##     ---                                                                                                    
## 141731:   A51256-451                <NA>     NA     NA      NA   <NA>   <NA>       NA       NA         <NA>
## 141732:   A51256-451                <NA>     NA     NA      NA   <NA>   <NA>       NA       NA         <NA>
## 141733:   A51256-451                <NA>     NA     NA      NA   <NA>   <NA>       NA       NA         <NA>
## 141734:   A51256-451                <NA>     NA     NA      NA   <NA>   <NA>       NA       NA         <NA>
## 141735:   A51256-451                <NA>     NA     NA      NA   <NA>   <NA>       NA       NA         <NA>
##          ISO2C  ISO3C  YEAR   JAN   FEB   MAR   APR   MAY   JUN   JUL   AUG   SEP   OCT   NOV   DEC
##         <char> <char> <int> <int> <int> <int> <int> <int> <int> <int> <int> <int> <int> <int> <int>
##      1:   <NA>   <NA>  2020     0     0    14     0     0     0     0     0     0     0     0     0
##      2:     NO    NOR  2020   736   695   744   717   744   718   743   742   718   694   708   740
##      3:     NO    NOR  2021   686   562   729   710   733   654   726   717   712   737   714   630
##      4:     NO    NOR  2022   549   513   292    98     0     0   137     0   292   709   708   724
##      5:     NO    NOR  2023   738   657   715   713   735   666   735   726   693   729   698   741
##     ---                                                                                            
## 141731:   <NA>   <NA>  2020  2165  1455  2144  2125  2199  2123  2112  2192  2083  2079  2074  2187
## 141732:   <NA>   <NA>  2021  2085  1992  2217  1975  2146  2092  2227  2170  2080  2163  2120  2168
## 141733:   <NA>   <NA>  2022  2203  1937  2204  2144  2218  2119  2224  2209  2137  1743  2126  2201
## 141734:   <NA>   <NA>  2023  2006  1988  2172  1993  2063  2088  2189  2182  2147  2199  2120  2197
## 141735:   <NA>   <NA>  2024  2223  1956  2215  2152  2221  2004  1229     0     0     0     0     0
```
...
##           STNID              NAME    LAT     LON ELEV(M)   CTRY  STATE    BEGIN      END COUNTRY_NAME  ISO2C
##          <char>            <char>  <num>   <num>   <num> <char> <char>    <int>    <int>       <char> <char>
## 1: 955510-99999 TOOWOOMBA AIRPORT -27.55 151.917     642     AS        19980301 20240717    AUSTRALIA     AU
## 2: 955510-99999 TOOWOOMBA AIRPORT -27.55 151.917     642     AS        19980301 20240717    AUSTRALIA     AU
## 3: 955510-99999 TOOWOOMBA AIRPORT -27.55 151.917     642     AS        19980301 20240717    AUSTRALIA     AU
## 4: 955510-99999 TOOWOOMBA AIRPORT -27.55 151.917     642     AS        19980301 20240717    AUSTRALIA     AU
## 5: 955510-99999 TOOWOOMBA AIRPORT -27.55 151.917     642     AS        19980301 20240717    AUSTRALIA     AU
##     ISO3C  YEAR   JAN   FEB   MAR   APR   MAY   JUN   JUL   AUG   SEP   OCT   NOV   DEC
##    <char> <int> <int> <int> <int> <int> <int> <int> <int> <int> <int> <int> <int> <int>
## 1:    AUS  2020   246   232   248   238   248   348   493   492   480   496   475   496
## 2:    AUS  2021   485   483   742   720   743   716   744   737   719   744   720   726
## 3:    AUS  2022   743   672   739   716   739   716   728   742   716   726   713   726
## 4:    AUS  2023   738   663   730   715   737   701   733   729   700   730   710   744
## 5:    AUS  2024   741   691   626   662   714   703   384     0     0     0     0     0
```
