...
To update _GSODR's_ internal database of station locations simply use `update_stations()`, which will update the internal station database according
to the latest data available from the NCEI.
...
```{r, eval=TRUE, message = FALSE, echo = FALSE, warning=FALSE, fig.width = 7, fig.height = 7, fig.align = "center"}
