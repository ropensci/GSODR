...
Additional climate data, [GSODdata](https://github.com/ropensci/GSODRdata), formatted for use with GSOD data provided by GSODR are available as an R package instalable through GitHub due to the package size, 5.1Mb, being too large for CRAN.
