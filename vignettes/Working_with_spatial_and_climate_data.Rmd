...
##### Compare the GSOD weather data from the Philippines with climatic data provided by the [`GSODRdata`](https://adamhsparks.github.io/GSODRdata/) package.

Install the `GSODRdata` package.
