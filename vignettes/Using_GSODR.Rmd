...
A list of stations is provided with the GSODR package for convience and speed.
However, this list is updated somewhat reguarly. If you would like to use the
